                        ...
                        <div class="col-md-12">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-header">
                                    ...
                                    <div class="additional-btn">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="current">Create invoice</li>
                                        </ol> 
                                    </div>
                                </div>
                                ...
                                <div class="widget-content padding">
                                    ...
                                    <?php echo form_open('invoice/add', array('class' => 'form-horizontal', 'id' => 'createCustomerForm')); ?>
                                    ...
                                    <div class="form-group">                                        
                                        <label  class="col-md-2">invoice Name</label>
                                           ...
                                           <div class="col-md-3">
                                            <input name="invoice_document_name" id="invoice_document_name" type="text" class="form-control" value="<?=set_value('invoice_document_name')?>">
                                             <?php echo form_error('invoice_document_name', '<div class="text-danger">', '</div>'); ?>
                                        </div>
                                        ...
                                        <label  class="col-md-2">invoice Id</label>
                                           ...
                                           <div class="col-md-3">
                                            <input name="invoice_id" id="invoice_id" type="text" class="form-control" value=""<?=set_value('invoice_id')?>">
                                             <?php echo form_error('invoice_id', '<div class="text-danger">', '</div>'); ?>
                                        </div>
                                        ...
                                        <label  class="col-md-2">invoice Address</label>
                                           ...
                                           <div class="col-md-3">
                                             <textarea class="form-control" name="invoice_address" style="height: 140px; resize: none;" ><?=set_value('invoice_address')?></textarea>

                                             <?php echo form_error('invoice_address', '<div class="text-danger">', '</div>'); ?>
                                        </div>
