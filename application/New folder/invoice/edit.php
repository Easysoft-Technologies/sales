                                ...
                                ?>
                                       ...
                                       <div class="form-group">                                        
                                        <label  class="col-md-2">invoice Name</label>
                                           ...
                                           <div class="col-md-3">
                                            <input name="invoice_document_name" id="invoice_document_name" type="text" class="form-control" value="<?=$invoice_data[0]['invoice_document_name']?>">
                                        ...
                                        <label  class="col-md-2">invoice Id</label>
                                           ...
                                           <div class="col-md-3">
                                            <input name="invoice_id" id="invoice_id" type="text" class="form-control" value="<?=$invoice_data[0]['invoice_no_of_records']?>">
                                        ...
                                        <label  class="col-md-2">invoice Address</label>
                                           ...
                                           <div class="col-md-3">
                                             <textarea class="form-control" name="invoice_address" style="height: 140px; resize: none;" ><?=$invoice_data[0]['invoice_address']?></textarea>
