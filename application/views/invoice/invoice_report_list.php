                ...
                <div class="main-page">                      
                    <div class="admin-right-cnt">	
                        <div class="row ">
                            ...
                            <div class="col-md-4">
                                <div class="admin-select-box">
                                    <input name="invoice_id" type="text" list="list_invoice_id" class="admn-right-form" placeholder="Invoice Number">
                                    
                                     <datalist id="list_invoice_id">
            <?php
           
            $orders_data = $this->obj_common->get_all('invoice_orders');
