                ...
                <div class="col-md-12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-header">
                            <h2><strong>Edit sales</strong></h2>
                            <div class="additional-btn">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="current">Edit sales</li>
                                </ol> 
                            </div>
                        </div>
                        ...
                        <div class="widget-content padding">
                            ...
                            <?php echo form_open('sales/edit/'.$id, array('class' => 'form-horizontal', 'id' => 'createCustomerForm')); ?>




                            <div class="row">
                                <h5 class="bg-darkblue-3 text-white-1" style="padding: 10px;"><strong>sales</strong></h5>
                            </div>
                            <?php if ($this->session->userdata('sales_msg') == TRUE) {
                                ?>
                                <div class="alert alert-success alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>                    
                                    <?php
                                    echo $this->session->userdata('sales_msg');
                                    $this->session->set_userdata('sales_msg', '');
                                    echo '</div>';
                                }
                                ?>
                                       ...
                                       <div class="form-group">                                        
                                        <label  class="col-md-2">sales Name</label>
                                           ...
                                           <div class="col-md-3">
                                            <input name="sales_document_name" id="sales_document_name" type="text" class="new-order-form" value="<?=$sales_data[0]['sales_document_name']?>">
                                        ...
                                        <label  class="col-md-2">sales Id</label>
                                           ...
                                           <div class="col-md-3">
                                            <input name="sales_id" id="sales_id" type="text" class="new-order-form" value="<?=$sales_data[0]['sales_no_of_records']?>">
                                        ...
                                        <label  class="col-md-2">sales Address</label>
                                           ...
                                           <div class="col-md-3">
                                             <textarea class="new-order-form" name="sales_address" style="height: 140px; resize: none;" ><?=$sales_data[0]['sales_address']?></textarea>
