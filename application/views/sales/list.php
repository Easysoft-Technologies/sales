                                            ...
                                            if ($sales) {
                                                foreach ($sales as $result) {
                                                    ...
                                                    ?>  >
                                                        ...
                                                        <td><a href="<?= site_url('sales/view/' . $result['sales_url']) ?>"><span class="icon-file table-icon"></span></a> 
                                                        <td><a href="<?= site_url('sales/not_upload_rows/' . $result['sales_url']) ?>"><i class="glyphicon glyphicon-list-alt"></i></a> 
