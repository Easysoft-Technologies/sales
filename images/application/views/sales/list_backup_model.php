            ...
            <div id="page-wrapper">
                <div class="main-page">
                    <div class="admin-right-cnt">	
                       ...
                       <!-----table popup-------->  
            <div id="myModalorder" tabindex="-1" class="newmodal modal fade report-fade-bg" role="dialog">
                                            ...
                                            if ($sales) {
                                                foreach ($sales as $result) {
                                                    ...
                                                    ?>  >
                                                        ...
                                                        <td><a rel="<?= site_url('sales/not_upload_rows/' . $result['sales_url']) ?>" href="<?= site_url('sales/not_upload_rows/' . $result['sales_url']) ?>" data-toggle="modal" data-target=".newmodal">View</a></td>                                     
